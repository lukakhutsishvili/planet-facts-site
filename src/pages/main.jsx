...
const Main = (props) => {
  ...
  const returncolor = (param) => {
    ...
    return planetColors[param.toLowerCase()];
  };
      ...
      >
        <InformationDiv>
          <Txt
            ...
            style={{ opacity: show === "Overview" && "1" }}
          >
            OVERVIEW
          </Txt>
          <Txt
            state={itemName}
            onClick={() => handleShow("Structure")}
            style={{ opacity: show === "Structure" && "1" }}
          >
            Structure
          </Txt>
          <Txt
            state={itemName}
            onClick={() => handleShow("Surface")}
            style={{ opacity: show === "Surface" && "1" }}
          >
            Surface
          </Txt>
        </InformationDiv>
          ...
          <AllInf>
            ...
            <InformationDivDesktop>
              <InfDiv
                ...
                onClick={() => handleShow("Overview")}
                style={{
                  background: show == "Overview" && returncolor(itemNameParam),
                }}
              >
                <TxtDesktop>
              ...
              <InfDiv
                ...
                onClick={() => handleShow("Structure")}
                style={{
                  background: show == "Structure" && returncolor(itemNameParam),
                }}
              >
                <TxtDesktop>
                  <span
              ...
              <InfDiv
                ...
                onClick={() => handleShow("Surface")}
                style={{
                  background: show == "Surface" && returncolor(itemNameParam),
                }}
              >
                <TxtDesktop>
